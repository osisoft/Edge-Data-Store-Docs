...
<html>
  ...
  <head>
    ...
    <title>Retrieve product version information </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Retrieve product version information ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="RetrieveProductVersionInformation1-0">
<h1 id="retrieve-product-version-information" sourcefile="V1/Administration/Retrieve product version information_1-0.md" sourcestartlinenumber="5" sourceendlinenumber="5">Retrieve product version information</h1>
          ...
          <div class="hidden-sm col-md-2" role="complementary">
            <div class="sideaffix">
              <div class="contribution">
                <ul class="nav">
                  <li>
                    <a href="https://github.com/osisoft/Edge-Data-Store-Docs/blob/master/V1/Administration/Retrieve product version information_1-0.md/#L1" class="contribution-link">Improve this Doc</a>
                  </li>
                </ul>
              </div>
