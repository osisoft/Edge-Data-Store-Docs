    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="visualizationQuickStart1-0">
<h1 id="edge-data-store-visualization-quick-start" sourcefile="V1/Overview/VisualizationQuickStart_1-0.md" sourcestartlinenumber="5" sourceendlinenumber="5">Edge Data Store visualization quick start</h1>

<p sourcefile="V1/Overview/VisualizationQuickStart_1-0.md" sourcestartlinenumber="7" sourceendlinenumber="7">This topic provides a quick start for displaying data from the EDS storage component on the local device where Edge Data Store is installed. The following example should run on any device supported by Edge Data Store, and iterates through all streams in the default namespace, continually displaying the latest values to the screen.</p>
<pre sourcefile="V1/Overview/VisualizationQuickStart_1-0.md" sourcestartlinenumber="9" sourceendlinenumber="106"><code class="lang-csharp">using System;
          ...
          <div class="hidden-sm col-md-2" role="complementary">
            <div class="sideaffix">
              <div class="contribution">
                <ul class="nav">
                  <li>
                    <a href="https://github.com/osisoft/Edge-Data-Store-Docs/blob/master/V1/Overview/VisualizationQuickStart_1-0.md/#L1" class="contribution-link">Improve this Doc</a>
                  </li>
                </ul>
              </div>
