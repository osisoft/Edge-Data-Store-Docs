...
<html>
  ...
  <head>
    ...
    <title>Configure Edge Data Store </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Configure Edge Data Store ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="ConfigureEdgeDataStore1-0">
<h1 id="configure-edge-data-store" sourcefile="V1/CommandLine/Configure Edge Data Store_1-0.md" sourcestartlinenumber="5" sourceendlinenumber="5">Configure Edge Data Store</h1>
          ...
          <div class="hidden-sm col-md-2" role="complementary">
            <div class="sideaffix">
              <div class="contribution">
                <ul class="nav">
                  <li>
                    <a href="https://github.com/osisoft/Edge-Data-Store-Docs/blob/master/V1/CommandLine/Configure Edge Data Store_1-0.md/#L1" class="contribution-link">Improve this Doc</a>
                  </li>
                </ul>
              </div>
